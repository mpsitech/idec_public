/**
  ...
  * job handler for job PnlIdecUsgAAccess (declarations)
...
/**
  * PnlIdecUsgAAccess
  */
class PnlIdecUsgAAccess : public JobIdec {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListIdecQUsgAAccess* rst = NULL, QryIdecUsgAAccess::StatShr* statshrqry = NULL, QryIdecUsgAAccess::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlIdecUsgAAccess(XchgIdec* xchg, DbsIdec* dbsidec, const ubigint jrefSup, const uint ixIdecVLocale);
	~PnlIdecUsgAAccess();
...
public:
	...
	QryIdecUsgAAccess* qry;

	IdecAMUsergroupAccess recUsgAacc;
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsIdec* dbsidec, QryIdecUsgAAccess::StgIac* _stgiacqry, DpchEngIdec** dpcheng);
