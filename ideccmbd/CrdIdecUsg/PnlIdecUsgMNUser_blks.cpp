/**
  * \file PnlIdecUsgMNUser_blks.cpp
  * job handler for job PnlIdecUsgMNUser (implementation of blocks)
...
void PnlIdecUsgMNUser::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "ContInfIdecUsgMNUser";

	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfIdecUsgMNUser";
...
void PnlIdecUsgMNUser::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixIdecVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppIdecUsgMNUser";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemAppIdecUsgMNUser";
...
void PnlIdecUsgMNUser::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StatShrIdecUsgMNUser";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrIdecUsgMNUser";
...
void PnlIdecUsgMNUser::Tag::writeXML(
			const uint ixIdecVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "TagIdecUsgMNUser";

	string itemtag;
	if (shorttags) itemtag = "Ti";
	else itemtag = "TagitemIdecUsgMNUser";
...
PnlIdecUsgMNUser::DpchAppData::DpchAppData() : DpchAppIdec(VecIdecVDpch::DPCHAPPIDECUSGMNUSERDATA) {
};
...
void PnlIdecUsgMNUser::DpchAppData::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppIdecUsgMNUserData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlIdecUsgMNUser::DpchAppDo::DpchAppDo() : DpchAppIdec(VecIdecVDpch::DPCHAPPIDECUSGMNUSERDO) {
	ixVDo = 0;
};
...
void PnlIdecUsgMNUser::DpchAppDo::readXML(
			pthread_mutex_t* mScr
			, map<string,ubigint>& descr
			, xmlXPathContext* docctx
			, string basexpath
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppIdecUsgMNUserDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlIdecUsgMNUser::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, const set<uint>& mask
		) : DpchEngIdec(VecIdecVDpch::DPCHENGIDECUSGMNUSERDATA, jref) {
...
void PnlIdecUsgMNUser::DpchEngData::merge(
			DpchEngIdec* dpcheng
		) {
...
void PnlIdecUsgMNUser::DpchEngData::writeXML(
			const uint ixIdecVLocale
			, pthread_mutex_t* mScr
	...
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngIdecUsgMNUserData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/idec");
		...
		if (has(STATAPPQRY)) QryIdecUsgMNUser::StatApp::writeXML(wr);
