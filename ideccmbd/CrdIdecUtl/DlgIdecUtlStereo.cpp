/**
  ...
  * job handler for job DlgIdecUtlStereo (implementation)
...
#include "DlgIdecUtlStereo_blks.cpp"

/******************************************************************************
 class DlgIdecUtlStereo
 ******************************************************************************/

DlgIdecUtlStereo::DlgIdecUtlStereo(
			XchgIdec* xchg
			, DbsIdec* dbsidec
			, const ubigint jrefSup
			, const uint ixIdecVLocale
		) : JobIdec(xchg, VecIdecVJob::DLGIDECUTLSTEREO, jrefSup, ixIdecVLocale) {
...
// IP cust --- INSERT
DpchEngIdec* DlgIdecUtlStereo::getNewDpchEng(
			set<uint> items
		) {
...
void DlgIdecUtlStereo::handleRequest(
			DbsIdec* dbsidec
			, ReqIdec* req
		) {
	if (req->ixVBasetype == ReqIdec::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixIdecVDpch == VecIdecVDpch::DPCHAPPDLGIDECUTLSTEREODATA) {
		...
		} else if (req->dpchapp->ixIdecVDpch == VecIdecVDpch::DPCHAPPDLGIDECUTLSTEREODO) {
...
void DlgIdecUtlStereo::handleDpchAppIdecInit(
			DbsIdec* dbsidec
...
void DlgIdecUtlStereo::handleDpchAppDataContiac(
			DbsIdec* dbsidec
			, ContIac* _contiac
			, DpchEngIdec** dpcheng
		) {
...
void DlgIdecUtlStereo::handleDpchAppDoButDneClick(
			DbsIdec* dbsidec
			, DpchEngIdec** dpcheng
		) {
...
void DlgIdecUtlStereo::handleCall(
			DbsIdec* dbsidec
			, Call* call
		) {
...
bool DlgIdecUtlStereo::handleCallIdecMastslvChg(
			DbsIdec* dbsidec
