/**
  * \file DlgIdecUtlQcdaln.cpp
  * job handler for job DlgIdecUtlQcdaln (implementation)
...
#include "DlgIdecUtlQcdaln_blks.cpp"

/******************************************************************************
 class DlgIdecUtlQcdaln
 ******************************************************************************/

DlgIdecUtlQcdaln::DlgIdecUtlQcdaln(
			XchgIdec* xchg
			, DbsIdec* dbsidec
			, const ubigint jrefSup
			, const uint ixIdecVLocale
		) : JobIdec(xchg, VecIdecVJob::DLGIDECUTLQCDALN, jrefSup, ixIdecVLocale) {
...
// IP cust --- INSERT
DpchEngIdec* DlgIdecUtlQcdaln::getNewDpchEng(
			set<uint> items
		) {
...
void DlgIdecUtlQcdaln::handleRequest(
			DbsIdec* dbsidec
			, ReqIdec* req
		) {
	if (req->ixVBasetype == ReqIdec::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixIdecVDpch == VecIdecVDpch::DPCHAPPDLGIDECUTLQCDALNDATA) {
		...
		} else if (req->dpchapp->ixIdecVDpch == VecIdecVDpch::DPCHAPPDLGIDECUTLQCDALNDO) {
...
void DlgIdecUtlQcdaln::handleDpchAppIdecInit(
			DbsIdec* dbsidec
...
void DlgIdecUtlQcdaln::handleDpchAppDataContiac(
			DbsIdec* dbsidec
			, ContIac* _contiac
			, DpchEngIdec** dpcheng
		) {
...
void DlgIdecUtlQcdaln::handleDpchAppDoButDneClick(
			DbsIdec* dbsidec
			, DpchEngIdec** dpcheng
		) {
...
void DlgIdecUtlQcdaln::handleCall(
			DbsIdec* dbsidec
			, Call* call
		) {
...
bool DlgIdecUtlQcdaln::handleCallIdecMastslvChg(
			DbsIdec* dbsidec
