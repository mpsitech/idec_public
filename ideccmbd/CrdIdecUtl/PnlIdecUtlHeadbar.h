/**
  ...
  * job handler for job PnlIdecUtlHeadbar (declarations)
...
/**
  * PnlIdecUtlHeadbar
  */
class PnlIdecUtlHeadbar : public JobIdec {
...
public:
	PnlIdecUtlHeadbar(XchgIdec* xchg, DbsIdec* dbsidec, const ubigint jrefSup, const uint ixIdecVLocale);
	~PnlIdecUtlHeadbar();
