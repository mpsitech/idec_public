/**
  ...
  * job handler for job DlgIdecUtlQcdaln (declarations)
...
/**
  * DlgIdecUtlQcdaln
  */
class DlgIdecUtlQcdaln : public JobIdec {
...
public:
	DlgIdecUtlQcdaln(XchgIdec* xchg, DbsIdec* dbsidec, const ubigint jrefSup, const uint ixIdecVLocale);
	~DlgIdecUtlQcdaln();
