/**
  * \file JobIdecLwiracq_blks.cpp
  * job handler for job JobIdecLwiracq (implementation of blocks)
...
/******************************************************************************
 class JobIdecLwiracq::VecVSge
 ******************************************************************************/

uint JobIdecLwiracq::VecVSge::getIx(
			const string& sref
		) {
...
string JobIdecLwiracq::VecVSge::getSref(
			const uint ix
		) {
...
void JobIdecLwiracq::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
