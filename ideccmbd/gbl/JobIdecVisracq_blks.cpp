/**
  * \file JobIdecVisracq_blks.cpp
  * job handler for job JobIdecVisracq (implementation of blocks)
...
/******************************************************************************
 class JobIdecVisracq::VecVSge
 ******************************************************************************/

uint JobIdecVisracq::VecVSge::getIx(
			const string& sref
		) {
...
string JobIdecVisracq::VecVSge::getSref(
			const uint ix
		) {
...
void JobIdecVisracq::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
