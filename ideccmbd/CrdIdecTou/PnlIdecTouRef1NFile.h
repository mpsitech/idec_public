/**
  ...
  * job handler for job PnlIdecTouRef1NFile (declarations)
...
/**
  * PnlIdecTouRef1NFile
  */
class PnlIdecTouRef1NFile : public JobIdec {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListIdecQTouRef1NFile* rst = NULL, QryIdecTouRef1NFile::StatShr* statshrqry = NULL, QryIdecTouRef1NFile::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlIdecTouRef1NFile(XchgIdec* xchg, DbsIdec* dbsidec, const ubigint jrefSup, const uint ixIdecVLocale);
	~PnlIdecTouRef1NFile();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsIdec* dbsidec, QryIdecTouRef1NFile::StgIac* _stgiacqry, DpchEngIdec** dpcheng);
