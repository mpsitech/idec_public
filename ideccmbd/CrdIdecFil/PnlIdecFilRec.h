/**
  ...
  * job handler for job PnlIdecFilRec (declarations)
...
/**
  * PnlIdecFilRec
  */
class PnlIdecFilRec : public JobIdec {
...
public:
	...
	public:
		StatShr(const uint ixIdecVExpstate = VecIdecVExpstate::REGD, const ubigint jrefDetail = 0, const bool ButRegularizeActive = true);
...
public:
	PnlIdecFilRec(XchgIdec* xchg, DbsIdec* dbsidec, const ubigint jrefSup, const uint ixIdecVLocale);
	~PnlIdecFilRec();
