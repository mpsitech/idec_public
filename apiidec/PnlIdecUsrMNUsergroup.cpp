/**
  ...
  * API code for job PnlIdecUsrMNUsergroup (implementation)
...
bool PnlIdecUsrMNUsergroup::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfIdecUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfIdecUsrMNUsergroup";
...
PnlIdecUsrMNUsergroup::StatApp::StatApp(
...
bool PnlIdecUsrMNUsergroup::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppIdecUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppIdecUsrMNUsergroup";
...
set<uint> PnlIdecUsrMNUsergroup::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlIdecUsrMNUsergroup::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlIdecUsrMNUsergroup::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrIdecUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrIdecUsrMNUsergroup";
...
bool PnlIdecUsrMNUsergroup::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagIdecUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemIdecUsrMNUsergroup";
...
PnlIdecUsrMNUsergroup::DpchAppData::DpchAppData(
			const string& scrJref
			, StgIac* stgiac
			, QryIdecUsrMNUsergroup::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchAppIdec(VecIdecVDpch::DPCHAPPIDECUSRMNUSERGROUPDATA, scrJref) {
...
void PnlIdecUsrMNUsergroup::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppIdecUsrMNUsergroupData");
...
PnlIdecUsrMNUsergroup::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppIdec(VecIdecVDpch::DPCHAPPIDECUSRMNUSERGROUPDO, scrJref) {
...
void PnlIdecUsrMNUsergroup::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppIdecUsrMNUsergroupDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/idec");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlIdecUsrMNUsergroup::DpchEngData::DpchEngData() : DpchEngIdec(VecIdecVDpch::DPCHENGIDECUSRMNUSERGROUPDATA) {
...
void PnlIdecUsrMNUsergroup::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngIdecUsrMNUsergroupData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryIdecUsrMNUsergroup::StatApp();
		statshrqry = QryIdecUsrMNUsergroup::StatShr();
