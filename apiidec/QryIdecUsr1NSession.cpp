/**
  ...
  * API code for job QryIdecUsr1NSession (implementation)
...
/******************************************************************************
 class QryIdecUsr1NSession::StatApp
 ******************************************************************************/

QryIdecUsr1NSession::StatApp::StatApp(
			const uint firstcol
...
bool QryIdecUsr1NSession::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryIdecUsr1NSession");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryIdecUsr1NSession";
...
set<uint> QryIdecUsr1NSession::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryIdecUsr1NSession::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryIdecUsr1NSession::StatShr
 ******************************************************************************/

QryIdecUsr1NSession::StatShr::StatShr(
			const uint ntot
...
bool QryIdecUsr1NSession::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryIdecUsr1NSession");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryIdecUsr1NSession";
...
set<uint> QryIdecUsr1NSession::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryIdecUsr1NSession::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryIdecUsr1NSession::StgIac
 ******************************************************************************/

QryIdecUsr1NSession::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryIdecUsr1NSession::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryIdecUsr1NSession");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryIdecUsr1NSession";
...
void QryIdecUsr1NSession::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryIdecUsr1NSession";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryIdecUsr1NSession";
...
set<uint> QryIdecUsr1NSession::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryIdecUsr1NSession::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
