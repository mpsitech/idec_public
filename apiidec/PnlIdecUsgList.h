/**
  ...
  * API code for job PnlIdecUsgList (declarations)
...
namespace PnlIdecUsgList {
	...
	public:
		DpchAppData(const string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryIdecUsgList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryIdecUsgList::StatApp statappqry;
