/**
  ...
  * API code for job PnlIdecUsgMNUser (declarations)
...
namespace PnlIdecUsgMNUser {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryIdecUsgMNUser::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryIdecUsgMNUser::StatApp statappqry;
