/**
  * \file PnlIdecUsrHeadbar.cpp
  * API code for job PnlIdecUsrHeadbar (implementation)
...
/******************************************************************************
 class PnlIdecUsrHeadbar::StgInf
 ******************************************************************************/

PnlIdecUsrHeadbar::StgInf::StgInf(
...
bool PnlIdecUsrHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfIdecUsrHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfIdecUsrHeadbar";
...
set<uint> PnlIdecUsrHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlIdecUsrHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlIdecUsrHeadbar::Tag
 ******************************************************************************/

PnlIdecUsrHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) : Block() {
	this->MenApp = MenApp;
...
bool PnlIdecUsrHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagIdecUsrHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemIdecUsrHeadbar";
...
/******************************************************************************
 class PnlIdecUsrHeadbar::DpchEngData
 ******************************************************************************/

PnlIdecUsrHeadbar::DpchEngData::DpchEngData() : DpchEngIdec(VecIdecVDpch::DPCHENGIDECUSRHEADBARDATA) {
};

string PnlIdecUsrHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlIdecUsrHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngIdecUsrHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
