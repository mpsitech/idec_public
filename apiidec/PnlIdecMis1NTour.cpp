/**
  ...
  * API code for job PnlIdecMis1NTour (implementation)
...
bool PnlIdecMis1NTour::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfIdecMis1NTour");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfIdecMis1NTour";
...
PnlIdecMis1NTour::StatApp::StatApp(
...
bool PnlIdecMis1NTour::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppIdecMis1NTour");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppIdecMis1NTour";
...
set<uint> PnlIdecMis1NTour::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlIdecMis1NTour::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlIdecMis1NTour::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrIdecMis1NTour");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrIdecMis1NTour";
...
bool PnlIdecMis1NTour::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagIdecMis1NTour");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemIdecMis1NTour";
...
PnlIdecMis1NTour::DpchAppData::DpchAppData(
			const string& scrJref
			, StgIac* stgiac
			, QryIdecMis1NTour::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchAppIdec(VecIdecVDpch::DPCHAPPIDECMIS1NTOURDATA, scrJref) {
...
void PnlIdecMis1NTour::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppIdecMis1NTourData");
...
PnlIdecMis1NTour::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppIdec(VecIdecVDpch::DPCHAPPIDECMIS1NTOURDO, scrJref) {
...
void PnlIdecMis1NTour::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppIdecMis1NTourDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/idec");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlIdecMis1NTour::DpchEngData::DpchEngData() : DpchEngIdec(VecIdecVDpch::DPCHENGIDECMIS1NTOURDATA) {
...
void PnlIdecMis1NTour::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngIdecMis1NTourData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryIdecMis1NTour::StatApp();
		statshrqry = QryIdecMis1NTour::StatShr();
