/**
  ...
  * API code for job PnlIdecFilDetail (implementation)
...
/******************************************************************************
 class PnlIdecFilDetail::VecVDo
 ******************************************************************************/

uint PnlIdecFilDetail::VecVDo::getIx(
			const string& sref
		) {
...
string PnlIdecFilDetail::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlIdecFilDetail::ContIac
 ******************************************************************************/

PnlIdecFilDetail::ContIac::ContIac(
			const string& TxfFnm
...
bool PnlIdecFilDetail::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacIdecFilDetail");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemIacIdecFilDetail";
...
void PnlIdecFilDetail::ContIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "ContIacIdecFilDetail";

	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemIacIdecFilDetail";
...
set<uint> PnlIdecFilDetail::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlIdecFilDetail::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlIdecFilDetail::ContInf
 ******************************************************************************/

PnlIdecFilDetail::ContInf::ContInf(
			const string& TxtClu
			, const string& TxtReu
		) : Block() {
	this->TxtClu = TxtClu;
...
bool PnlIdecFilDetail::ContInf::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfIdecFilDetail");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfIdecFilDetail";
...
set<uint> PnlIdecFilDetail::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlIdecFilDetail::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlIdecFilDetail::StatApp
 ******************************************************************************/

PnlIdecFilDetail::StatApp::StatApp(
	...
	mask = {IXIDECVEXPSTATE, LSTCLUALT, PUPCNTALT, PUPMIMALT, LSTCLUNUMFIRSTDISP};
};

bool PnlIdecFilDetail::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppIdecFilDetail");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppIdecFilDetail";
...
set<uint> PnlIdecFilDetail::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlIdecFilDetail::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {IXIDECVEXPSTATE, LSTCLUALT, PUPCNTALT, PUPMIMALT, LSTCLUNUMFIRSTDISP};
	for (auto it=commitems.begin();it!=commitems.end();it++) diffitems.erase(*it);
...
/******************************************************************************
 class PnlIdecFilDetail::StatShr
 ******************************************************************************/

PnlIdecFilDetail::StatShr::StatShr(
...
bool PnlIdecFilDetail::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrIdecFilDetail");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrIdecFilDetail";
...
set<uint> PnlIdecFilDetail::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlIdecFilDetail::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlIdecFilDetail::Tag
 ******************************************************************************/

PnlIdecFilDetail::Tag::Tag(
			const string& Cpt
			, const string& CptFnm
			, const string& CptClu
			, const string& CptReu
...
bool PnlIdecFilDetail::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagIdecFilDetail");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemIdecFilDetail";
...
/******************************************************************************
 class PnlIdecFilDetail::DpchAppData
 ******************************************************************************/

PnlIdecFilDetail::DpchAppData::DpchAppData(
			const string& scrJref
			, ContIac* contiac
			, const set<uint>& mask
		) : DpchAppIdec(VecIdecVDpch::DPCHAPPIDECFILDETAILDATA, scrJref) {
...
string PnlIdecFilDetail::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlIdecFilDetail::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppIdecFilDetailData");
...
/******************************************************************************
 class PnlIdecFilDetail::DpchAppDo
 ******************************************************************************/

PnlIdecFilDetail::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppIdec(VecIdecVDpch::DPCHAPPIDECFILDETAILDO, scrJref) {
...
string PnlIdecFilDetail::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlIdecFilDetail::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppIdecFilDetailDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/idec");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
/******************************************************************************
 class PnlIdecFilDetail::DpchEngData
 ******************************************************************************/

PnlIdecFilDetail::DpchEngData::DpchEngData() : DpchEngIdec(VecIdecVDpch::DPCHENGIDECFILDETAILDATA) {
...
string PnlIdecFilDetail::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlIdecFilDetail::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngIdecFilDetailData");
	else
		basefound = checkXPath(docctx, basexpath);
