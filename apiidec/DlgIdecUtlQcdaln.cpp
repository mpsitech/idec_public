/**
  ...
  * API code for job DlgIdecUtlQcdaln (implementation)
...
bool DlgIdecUtlQcdaln::ContInf::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfDlgIdecUtlQcdaln");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfDlgIdecUtlQcdaln";
...
DlgIdecUtlQcdaln::StatApp::StatApp(
...
bool DlgIdecUtlQcdaln::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppDlgIdecUtlQcdaln");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppDlgIdecUtlQcdaln";
...
set<uint> DlgIdecUtlQcdaln::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> DlgIdecUtlQcdaln::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool DlgIdecUtlQcdaln::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagDlgIdecUtlQcdaln");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemDlgIdecUtlQcdaln";
...
DlgIdecUtlQcdaln::DpchAppData::DpchAppData(
			const string& scrJref
			, ContIac* contiac
			, const set<uint>& mask
		) : DpchAppIdec(VecIdecVDpch::DPCHAPPDLGIDECUTLQCDALNDATA, scrJref) {
...
void DlgIdecUtlQcdaln::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppDlgIdecUtlQcdalnData");
...
DlgIdecUtlQcdaln::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppIdec(VecIdecVDpch::DPCHAPPDLGIDECUTLQCDALNDO, scrJref) {
...
void DlgIdecUtlQcdaln::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppDlgIdecUtlQcdalnDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/idec");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
DlgIdecUtlQcdaln::DpchEngData::DpchEngData() : DpchEngIdec(VecIdecVDpch::DPCHENGDLGIDECUTLQCDALNDATA) {
...
void DlgIdecUtlQcdaln::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngDlgIdecUtlQcdalnData");
	else
		basefound = checkXPath(docctx, basexpath);
