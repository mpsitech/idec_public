/**
  ...
  * API code for job PnlIdecMis1NTour (declarations)
...
namespace PnlIdecMis1NTour {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryIdecMis1NTour::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryIdecMis1NTour::StatApp statappqry;
