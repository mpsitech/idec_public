/**
  ...
  * API code for job QryIdecTouRef1NFile (implementation)
...
/******************************************************************************
 class QryIdecTouRef1NFile::StatApp
 ******************************************************************************/

QryIdecTouRef1NFile::StatApp::StatApp(
			const uint firstcol
...
bool QryIdecTouRef1NFile::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryIdecTouRef1NFile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryIdecTouRef1NFile";
...
set<uint> QryIdecTouRef1NFile::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryIdecTouRef1NFile::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryIdecTouRef1NFile::StatShr
 ******************************************************************************/

QryIdecTouRef1NFile::StatShr::StatShr(
			const uint ntot
...
bool QryIdecTouRef1NFile::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryIdecTouRef1NFile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryIdecTouRef1NFile";
...
set<uint> QryIdecTouRef1NFile::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryIdecTouRef1NFile::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryIdecTouRef1NFile::StgIac
 ******************************************************************************/

QryIdecTouRef1NFile::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryIdecTouRef1NFile::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryIdecTouRef1NFile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryIdecTouRef1NFile";
...
void QryIdecTouRef1NFile::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryIdecTouRef1NFile";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryIdecTouRef1NFile";
...
set<uint> QryIdecTouRef1NFile::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryIdecTouRef1NFile::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
