/**
  ...
  * API code for job PnlIdecMisRef1NFile (declarations)
...
namespace PnlIdecMisRef1NFile {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryIdecMisRef1NFile::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryIdecMisRef1NFile::StatApp statappqry;
