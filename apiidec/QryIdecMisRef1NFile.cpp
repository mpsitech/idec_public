/**
  ...
  * API code for job QryIdecMisRef1NFile (implementation)
...
/******************************************************************************
 class QryIdecMisRef1NFile::StatApp
 ******************************************************************************/

QryIdecMisRef1NFile::StatApp::StatApp(
			const uint firstcol
...
bool QryIdecMisRef1NFile::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryIdecMisRef1NFile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryIdecMisRef1NFile";
...
set<uint> QryIdecMisRef1NFile::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryIdecMisRef1NFile::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryIdecMisRef1NFile::StatShr
 ******************************************************************************/

QryIdecMisRef1NFile::StatShr::StatShr(
			const uint ntot
...
bool QryIdecMisRef1NFile::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryIdecMisRef1NFile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryIdecMisRef1NFile";
...
set<uint> QryIdecMisRef1NFile::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryIdecMisRef1NFile::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryIdecMisRef1NFile::StgIac
 ******************************************************************************/

QryIdecMisRef1NFile::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryIdecMisRef1NFile::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryIdecMisRef1NFile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryIdecMisRef1NFile";
...
void QryIdecMisRef1NFile::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryIdecMisRef1NFile";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryIdecMisRef1NFile";
...
set<uint> QryIdecMisRef1NFile::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryIdecMisRef1NFile::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
