/**
  ...
  * API code for job DlgIdecUtlTheta (implementation)
...
bool DlgIdecUtlTheta::ContInf::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfDlgIdecUtlTheta");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfDlgIdecUtlTheta";
...
DlgIdecUtlTheta::StatApp::StatApp(
			const bool initdone
...
bool DlgIdecUtlTheta::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppDlgIdecUtlTheta");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppDlgIdecUtlTheta";
...
set<uint> DlgIdecUtlTheta::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> DlgIdecUtlTheta::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool DlgIdecUtlTheta::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagDlgIdecUtlTheta");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemDlgIdecUtlTheta";
...
DlgIdecUtlTheta::DpchAppData::DpchAppData(
			const string& scrJref
			, ContIac* contiac
			, const set<uint>& mask
		) : DpchAppIdec(VecIdecVDpch::DPCHAPPDLGIDECUTLTHETADATA, scrJref) {
...
void DlgIdecUtlTheta::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppDlgIdecUtlThetaData");
...
DlgIdecUtlTheta::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppIdec(VecIdecVDpch::DPCHAPPDLGIDECUTLTHETADO, scrJref) {
...
void DlgIdecUtlTheta::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppDlgIdecUtlThetaDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/idec");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
DlgIdecUtlTheta::DpchEngData::DpchEngData() : DpchEngIdec(VecIdecVDpch::DPCHENGDLGIDECUTLTHETADATA) {
...
void DlgIdecUtlTheta::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngDlgIdecUtlThetaData");
	else
		basefound = checkXPath(docctx, basexpath);
